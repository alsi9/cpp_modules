...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/12 15:29:35 by ephantom          #+#    #+#             */
/*   Updated: 2022/05/12 16:29:39 by ephantom         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << GREEN"Clap Trap " << name << ": hello! (default constructor)"END << std::endl;
    hit_points = 10;
    energy_points = 10;
    attack_damage = 0;
}
...
{
    std::cout << GREEN"Clap Trap " << name << ": hello! (name constructor)"END << std::endl;
    hit_points = 10;
    energy_points = 10;
    attack_damage = 0;
}
...
ClapTrap::~ClapTrap()
{
    std::cout << RED"Clap Trap " << name << ": goodbye! (destructor)"END << std::endl;
}
