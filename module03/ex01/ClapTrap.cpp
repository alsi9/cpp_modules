...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/12 15:30:39 by ephantom          #+#    #+#             */
/*   Updated: 2022/05/12 15:30:42 by ephantom         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    {
        hit_points = 0;
        std::cout << name << " can't take damage because is already dead!" << std::endl;
        return ;
    }
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (hit_points <= 0)
    {
        std::cout << name <<  " can't be repaired because is already dead!" << std::endl;
        return ;
    }
    if (energy_points <= 0)
    {
        energy_points = 0;
        std::cout << name << " can't be repaired because it has no energy points!" << std::endl;
        return ;
    }
